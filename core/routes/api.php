...
Route::namespace ('Api')->name('api.')->group(function () {
    ...
    //get-api show Admins
    Route::get('show-admins', [AdminController::class, 'showAdmins']);
    //post-api add Admins
    Route::post('add-admins', [AdminController::class, 'addAdmins']);
    //delete-api add Admins
    Route::delete('delete-admins/{id}', [AdminController::class, 'deleteAdmins']);
