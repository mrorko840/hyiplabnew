...
<div class="calculate-area">
    <div class="calculator"><img src="{{ asset('assets/templates/bit_gold/images/elements/budget.png') }}"
            alt="image"></div>
    <div class="shape-1"><img src="{{ asset('assets/templates/bit_gold/images/elements/cal-1.png') }}" alt="image">
    </div>
    <div class="shape-2"><img src="{{ asset('assets/templates/bit_gold/images/elements/cal-2.png') }}" alt="image">
    </div>
    <div class="shape-3"><img src="{{ asset('assets/templates/bit_gold/images/elements/cal-3.png') }}" alt="image">
    </div>
    <div class="shape-4"><img src="{{ asset('assets/templates/bit_gold/images/elements/cal-4.png') }}" alt="image">
    </div>
        ...
        <form class="profit-calculator">
            <div class="row">
                <div class="mb-3 col-lg-6">
                    ...
                    <select class="base--bg" id="changePlan">
                        @foreach ($planList as $k => $data)
                            <option value="{{ $data->id }}" data-fixed_amount="{{ $data->fixed_amount }}"
                                data-minimum_amount="{{ $data->minimum }}" data-maximum_amount="{{ $data->maximum }}">
                                {{ $data->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3 col-lg-6">
                    ...
                    <input type="text" placeholder="0.00" class="form-control base--bg invest-input"
            ...
            <div class="col-lg-6">
                <div class="section-header text-center">
                    <h2 class="section-title"><span
                            class="font-weight-normal">{{ __(@$calculationCaption->data_values->heading_w) }}</span> <b
                            class="base--color">{{ __(@$calculationCaption->data_values->heading_c) }}</b></h2>
